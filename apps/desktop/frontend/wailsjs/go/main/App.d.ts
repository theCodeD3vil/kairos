...
export function CheckFreshInstallation():Promise<main.FreshInstallStatus>;
...
export function GetExtensionStatusForEditor(arg1:string):Promise<contracts.ExtensionStatus>;
...
export function GetVSCodeBridgeHealth():Promise<boolean>;
...
export function InstallFreshPlugin():Promise<void>;

export function ListExtensionStatuses():Promise<Array<contracts.ExtensionStatus>>;
